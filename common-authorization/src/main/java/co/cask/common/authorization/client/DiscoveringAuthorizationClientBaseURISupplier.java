 ...
 */
public class DiscoveringAuthorizationClientBaseURISupplier implements BaseURISupplier {

  private final Supplier<InetSocketAddress> addressSupplier;

  @Inject
  public DiscoveringAuthorizationClientBaseURISupplier(final DiscoveryServiceClient discoveryServiceClient) {
  ...
  public URI get() {
    ...
    // TODO: probably need CConfiguration to determine whether to use http or https
